...
class Household {
    ...
    String status = "ACTIVE";     // ACTIVE|EXITED           ✅ GAP FIX
    String exitReason;                                        // ✅ GAP FIX
    java.time.LocalDate exitDate;                              // ✅ GAP FIX
}

class BarangayOfficial {
    String officialId, name, email, password;
    boolean isAdmin;                                           // ✅ GAP FIX
}
...
class ComplianceRecord {
    ...
    int elementaryCount, juniorHighCount, seniorHighCount;      // ✅ GAP FIX — replaces childrenMeetingAttendance
    String recordedByOfficialId;                                // ✅ GAP FIX
}
...
class GrantBreakdown {
    ...
    String recordType = "INITIAL";   // INITIAL|CORRECTION      ✅ GAP FIX
    String correctionReason;                                    // ✅ GAP FIX, nullable
}
...
class JobseekerProfile {
    ...
    List<String> skills;
    int experienceYears;
    Map<String,String> appliedVacancies;  // values: APPLIED | FOR_INTERVIEW | REJECTED | HIRED  (HIRED ✅ GAP FIX)
}
